...
def vis_parsing_maps(im, origin, parsing_anno, stride, save_im=False, save_path='baby.jpg', mod='red'):
...
def evaluate(cp='model/model.pth', input_path='girl2.jpg', output_path='baby.jpg', mode='red'):
...
if __name__ == "__main__":
    evaluate(input_path='files/girl2.jpg', output_path='files/baby.jpg', mode='red')
